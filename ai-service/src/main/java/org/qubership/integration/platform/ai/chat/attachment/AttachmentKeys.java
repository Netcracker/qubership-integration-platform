...
public final class AttachmentKeys {
   ...
   * <ul>
   *   <li>a single S3 object key</li>
   *   <li>a newline-separated list of keys</li>
   *   <li>a markdown bullet line that contains a download URL</li>
   *   <li>a URL with a {@code key} query parameter</li>
   * </ul>

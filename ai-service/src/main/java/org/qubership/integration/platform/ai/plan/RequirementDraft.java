...
public record RequirementDraft(
  ...
  private static String normalizePreferredSystemType(String raw) {
  ...
  public String resolvedPreferredSystemType() {
    return preferredSystemType == null ? "INTERNAL" : preferredSystemType;
  }

...
public class CatalogBindingMatcher {
  ...
  public MatchResult match(
    ...
    String search = CatalogStrings.blankToNull(serviceName) != null ? serviceName : query;
    List<CatalogRestClient.SystemDto> systems = catalogReadTool.searchCatalogSystems(search);
    if (systems.isEmpty() && CatalogStrings.blankToNull(serviceName) != null) {
  ...
  public Optional<CatalogMatch> revalidateHint(
    ...
    String search =
        CatalogStrings.blankToNull(serviceName) != null ? serviceName : operationQuery;
  ...
  private static boolean protocolAgrees(String requiredProtocol, String catalogProtocol) {
    if (CatalogStrings.blankToNull(requiredProtocol) == null) {
      return true;
    }
    return requiredProtocol.equalsIgnoreCase(CatalogStrings.blankToNull(catalogProtocol));
  }

...
@TemplatesHelper
public class MapperInterpreterHelper extends BaseHelper {
    ...
    public String apply(String mappingDescriptionAsString, Options options) {
        try {
            ...
            if (context instanceof Element element && e.getElement().isEmpty()) {
                throw new TemplateInstantiationException(e.getMessage(), element, e.getOriginalException().orElse(null));
            }
            throw e;
        }
    }

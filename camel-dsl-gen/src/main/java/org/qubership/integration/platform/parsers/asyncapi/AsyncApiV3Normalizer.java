...
package org.qubership.integration.platform.parsers.asyncapi;

import com.fasterxml.jackson.databind.ObjectMapper;
import lombok.extern.slf4j.Slf4j;
import org.qubership.integration.platform.parsers.SpecificationParserException;
import org.qubership.integration.platform.parsers.model.asyncapi.*;
import org.qubership.integration.platform.parsers.model.asyncapi.components.Components;
import org.qubership.integration.platform.parsers.model.asyncapi.components.SchemaObject;
import org.qubership.integration.platform.parsers.model.asyncapi.v3.*;

import java.util.*;

/**
 * Converts an AsyncAPI 3.0 document into the 2.x model the resolvers consume.
 *
 * <p>The AsyncAPI 3.0 structure separates operations from channels and replaces the
 * {@code publish}/{@code subscribe} keywords with {@code send}/{@code receive} actions. This
 * normalizer maps operations back onto their channels, resolves inline and referenced messages, and
 * expands reply operations into their own channel entries so the downstream resolvers see a single
 * 2.x shape regardless of the source version.
 */
@Slf4j
public class AsyncApiV3Normalizer {
    ...
    public AsyncApiV3Normalizer(ObjectMapper objectMapper) {

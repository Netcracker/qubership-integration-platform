...
public final class TriggerUtils {
    ...
    public static ElementRoute getHttpTriggerRoute(Element element) {
    ...
    public static String getSdsTriggerJobId(Element element) {
        Map<String, Object> properties = element.getProperties();
        return (String) properties.get(CamelOptions.SDS_JOB_ID);
    }

    public static Long getHttpConnectionTimeout(Element element) {
    ...
    @NotNull
    public static String getHttpTriggerPathWithoutBase(Element element) {
        Map<String, Object> properties = element.getProperties();
    ...
    public static String getHttpTriggerBasePath(Element element) {
        String base = element.getEnvironment()
    ...
    @NotNull
    public static String getHttpTriggerPath(Element element) {
    ...
    public static boolean areHttpTriggerMethodsSpecified(Element element) {
    ...
    @NotNull
    public static Set<HttpMethod> getHttpTriggerMethods(Element element) {
        String httpMethodsString = (String) element.getProperties().getOrDefault(CamelOptions.HTTP_METHOD_RESTRICT, "");
    ...
    public static boolean isHttpTrigger(Element element) {
        return CamelNames.HTTP_TRIGGER_COMPONENT.equals(element.getType());
    }

    public static boolean isAsyncTrigger(Element element) {
        return ASYNC_TRIGGER_TYPE_NAMES.contains(element.getType());
    }

    public static boolean isImplementedServiceTrigger(Element element) {
        return StringUtils.isNotBlank((String) element.getProperties().get(CamelOptions.OPERATION_PATH));
    }

    public static boolean isCustomUriHttpTrigger(Element element) {
        return StringUtils.isNotBlank((String) element.getProperties().get(CamelOptions.CONTEXT_PATH));
    }

    public static String getImplementedServiceTriggerSystemId(Element element) {
        return (String) element.getProperties().get(CamelOptions.SYSTEM_ID);
    }

    public static String getImplementedServiceTriggerSpecificationId(Element element) {
        return (String) element.getProperties().get(CamelOptions.MODEL_ID);
    }

    public static String getImplementedServiceTriggerOperationId(Element element) {
        return (String) element.getProperties().get(CamelOptions.OPERATION_ID);
    }

    public static String getHttpTriggerValidationSchema(Element element) {

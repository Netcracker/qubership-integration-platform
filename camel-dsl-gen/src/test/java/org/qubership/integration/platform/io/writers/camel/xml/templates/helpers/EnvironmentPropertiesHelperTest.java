...
public class EnvironmentPropertiesHelperTest {
    ...
    public void environmentPropertiesJsonTest() throws IOException, JSONException {
        ...
        Element testData = ElementBuilder.createNew()
            .serviceEnvironment(objectMapper.readValue(environmentJson, ServiceEnvironmentImpl.class))
            .build();
    ...
    public void nullEnvironmentPropertiesJsonTest() {
        ...
        assertThrows(TemplateInstantiationException.class, () -> helper.environmentPropertiesJson(testData));
    }
    ...
    public void nullAsyncEnvironmentPropertiesJsonTest() {
        ...
        assertThrows(TemplateInstantiationException.class, () -> helper.asyncPropertiesJson(testData));
    }
}

...
import org.qubership.integration.platform.designtime.catalog.rest.v1.dto.folder.*;
...
public class FolderController {
    ...
    public ResponseEntity<List<? extends FolderItemResponse>> findRootFolder(
        ...
        List<Chain> chainsInRoot = chainService.findInRoot(filter);
    ...
    public ResponseEntity<FolderResponse> findById(
        ...
        Set<String> chainIds = chainService.findChainsInFolder(folderId, filter).stream()
    ...
    private void addOpenedFolderHierarchy(String openedFolderId, List<FolderItemResponse> response) {
        ...
        List<Chain> openedFolderRelatedChains = chainService.findAllChainsToRootParentFolder(openedFolderId);

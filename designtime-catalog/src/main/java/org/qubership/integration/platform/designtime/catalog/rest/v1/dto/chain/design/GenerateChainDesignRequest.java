...
@Getter
@Setter
@Schema(description = "Design generation request")
public class GenerateChainDesignRequest {
    @Schema(description = "Requested diagram modes")
    private List<DiagramMode> diagramModes;
}

...
public interface DetailedDesignMapper {

    DDSTemplateResponse asResponse(DetailedDesignTemplate templates);

    List<DDSTemplateResponse> asResponses(List<DetailedDesignTemplate> templates);

...
import org.qubership.integration.platform.engine.opensearch.StandaloneDbaasOpensearchClient;
...
public class OpenSearchStandaloneAutoConfiguration {
    ...
    public DbaasOpensearchClient opensearchClient() {
        ...
        return new StandaloneDbaasOpensearchClient(new OpenSearchClient(builder.build()), prefix);
    }
}

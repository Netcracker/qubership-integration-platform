...
public abstract class ComparisonExpression extends BinaryExpression implements BooleanExpression {
    ...
    static class LikeExpression extends
        org.qubership.integration.platform.engine.mapper.atlasmap.expressions.UnaryExpression implements BooleanExpression {
    ...
    public static BooleanExpression createNotLike(Expression left, String right, String escape) {
        return org.qubership.integration.platform.engine.mapper.atlasmap.expressions.UnaryExpression.createNOT(createLike(left, right, escape));
    }
    ...
    public static BooleanExpression createInFilter(Expression left, List elements) {
        ...
        return org.qubership.integration.platform.engine.mapper.atlasmap.expressions.UnaryExpression.createInExpression((VariableExpression)left, elements, false);
    ...
    public static BooleanExpression createNotInFilter(Expression left, List elements) {
        ...
        return org.qubership.integration.platform.engine.mapper.atlasmap.expressions.UnaryExpression.createInExpression((VariableExpression)left, elements, true);
    ...
    public static BooleanExpression createIsNotNull(Expression left) {
        return org.qubership.integration.platform.engine.mapper.atlasmap.expressions.UnaryExpression.createNOT(doCreateEqual(left, ConstantExpression.NULL));
    }
    ...
    private static BooleanExpression doCreateEqual(Expression left, Expression right) {
        return new ComparisonExpression(left, right) {
            ...
            private Object evaluateValue(Expression expression, ExpressionContext context) throws ExpressionException {
                Field field = expression.evaluate(context);
                return FieldType.COMPLEX.equals(field.getFieldType())
                        ? FieldStatus.NOT_FOUND.equals(field.getStatus()) ? null : field
                        : field.getValue();
            }

            public Field evaluate(ExpressionContext expressionContext) throws ExpressionException {
                Object lv = evaluateValue(left, expressionContext);
                Object rv = evaluateValue(right, expressionContext);

...
Cloud Integration Platform (CIP) is an open-source solution built on Apache Camel (for more details see [Apache Camel](https://camel.apache.org/index.html)).

...
| --------------------------------- | :-------- | :-------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Value                             | M         | String    | Field, that can specify:<ul><li>**Counter** value, entered with number or reference to property/variable. Simply number of looped runs.</li><li>**doWhile expression**, that makes the flow exit the Loop, when expression evaluates to false.</li></ul>When **number** entered, but **"Expression used"** checkbox is enabled, field becomes highlighted with red and does not allow to save the settings in such state. | Property: `${exchangeProperty.userListSize}`<br>Expression: `${headers.iterations}<10` |

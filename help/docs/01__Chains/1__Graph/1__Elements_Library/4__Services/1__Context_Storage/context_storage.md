...
| Operation                        | M         | List      | List, that contains all available context operations. Possible values:<ul><li>Create context</li><li>Get context</li><li>Delete context</li></ul>                                                                                                                                                                            | Get context           |
...
| Target            | O         | List      | Specifies where chain context details will be placed:<ul><li>Body</li><li>Header</li><li>Property</li></ul>                                       | Body        |
| Target field name | C         | List      | Exact target field's name where context details will be placed. The field becomes unavailable when 'Body' is selected for the "Target" parameter. | contextData |

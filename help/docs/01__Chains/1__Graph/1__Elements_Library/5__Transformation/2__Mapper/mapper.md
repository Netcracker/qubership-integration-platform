...
> ℹ️ **Note:** During the first launch of the chain with Mapper element **system performance may be impacted** due to resource-intensive data caching. Subsequent requests will perform optimally.

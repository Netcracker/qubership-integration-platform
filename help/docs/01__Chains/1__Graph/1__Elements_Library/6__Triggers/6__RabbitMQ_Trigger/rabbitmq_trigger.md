...
| Routing Key   | O         | String    | The routing key that binds the queue to the exchange.                                                                                                                   | rkey-1          |
...
| Routing Key                | O         | String    | The routing key that binds the queue to the exchange.                                                                                                                                                                   | rkey1         |
...
| Exchange Type             | M         | List      | The type the exchange is declared with, such as direct or topic. Enum values: <ul><li>direct</li><li>fanout</li><li>headers</li><li>topic</li></ul>**Default value:** direct                                                                                                                                                                                                                                    | direct                 |
| Dead Letter Exchange      | O         | String    | The exchange rejected messages are routed to.                                                                                                                                                                                                                                                                                                   | x-dead-letter-exchange |
| Dead Letter Exchange Type | O         | List      | The type the dead letter exchange is declared with. Enum values:<ul><li>direct</li><li>fanout</li><li>headers</li><li>topic</li></ul>**Default value:** direct                                                                                                                                                                                                                                           | direct                 |
| Dead Letter Queue         | O         | String    | The queue rejected messages are routed to.                                                                                                                                                                                                                                                                                                      | basic.queue            |
| Dead Letter Routing Key   | O         | String    | The routing key that binds the dead letter queue to the dead letter exchange.                                                                                                                                                                                                                                                                                              | dlrkey1                |
...
> ℹ️ **Note:** The chain consumes from a topology it does not create. **Exchange Type**, **Routing Key** and the four **Dead Letter** parameters describe an exchange, a queue and a binding that MaaS or a broker administrator declares. Dead lettering is an argument of the queue, set when the queue is declared, so filling these fields does not change a queue that already exists. What the chain does check is that the queue is there: a deployment whose queue is missing stays in `PROCESSING` and is retried until the queue appears.

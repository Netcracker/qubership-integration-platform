...
|--------------------------------------------------------|-----------------------------------------|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| Provider URL            | M                                       | String                                  | Path to JNDI service provider.                                                                                                                                                                        | "t3://devapp066.CIP.com:7154"       |
...
| Type                    | M                                       | List                                    | Type of the source: <ul><li>queue</li> <li>topic</li></ul><br/>**Default value:** queue                                                                                                                     | queue                                        |

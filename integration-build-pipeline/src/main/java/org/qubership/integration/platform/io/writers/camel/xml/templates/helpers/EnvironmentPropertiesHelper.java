...
public class EnvironmentPropertiesHelper {
    ...
    public Map<String, Object> environmentProperties(Element element) {
        ServiceEnvironment environment = element.getEnvironment()
            .orElseThrow(() -> new TemplateInstantiationException("Couldn't find service or active service environment.", element));
    ...
    public CharSequence environmentPropertiesJson(Element element) {
    ...
    public Map<String, Object> asyncProperties(Element element) {
        ServiceEnvironment environment = element.getEnvironment()
            .orElseThrow(() -> new TemplateInstantiationException("Couldn't find service or active service environment.", element));
     ...
     */
    @SuppressWarnings("unused")
    public CharSequence asyncPropertiesJson(Element element) {
    ...
    private static void putMassParams(Element element, ServiceEnvironment environment) {
        ...
        if (StringUtils.isNotEmpty(operationProtocolType)) {
            ...
            for (String param : maasParamList) {
                environment.getProperties().put(param, MaasUtils.getMaasParamPlaceholder(element.getOriginalId().orElseGet(element::getType), param));
            }
        }
    }

    public Map<String, Object> grpcProperties(Element element) {
        ServiceEnvironment environment = element.getEnvironment()
            .orElseThrow(() -> new TemplateInstantiationException("Couldn't find service or active service environment.", element));
     ...
     */
    @SuppressWarnings("unused")
    public CharSequence grpcPropertiesJson(Element element) {
        try {

...
public class ParentIdentifierHelper implements Helper<Element> {

    @Override
    public Object apply(Element element, Options options) {
        return element.getParent().map(Element::getId).orElse(StringUtils.EMPTY);
    }
}

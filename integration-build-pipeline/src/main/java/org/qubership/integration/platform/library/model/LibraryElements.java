...
package org.qubership.integration.platform.library.model;
...
public class LibraryElements {
    ...
    public void addChild(LibraryElementGroup group) {
        groups.add(group);
    }
    ...
    public void addChild(String name, ElementDescriptor element) {

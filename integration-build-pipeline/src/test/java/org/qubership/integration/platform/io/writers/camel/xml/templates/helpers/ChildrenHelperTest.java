...
import org.qubership.integration.platform.testutils.TestUtils;
...
import org.qubership.integration.platform.testutils.mapper.ChainElementsMapper;
import org.qubership.integration.platform.testutils.mapper.ChainMapper;
...
import static org.qubership.integration.platform.io.writers.camel.xml.templates.helpers.ChildrenHelper.SORT_PROP;
...
@ContextConfiguration(classes = {
        ...
        ServiceEnvironmentMapper.class
})
...
public class ChildrenHelperTest {
    ...
    public void childrenTest(String scenario, String childName, String inputPath, String outputPath) throws IOException {
        ...
        Element testData = chainMapper.toEntity(yamlMapper.readValue(TestUtils.getResourceFileContent(inputPath), ChainDTO.class))
                .getElements().stream()
                .filter(it -> it.getParent().isEmpty())
                .findFirst()

...
public class EndpointHelperSourceManualTest {
    ...
    public void externalRoutePathTestManual() {
        Element httpSenderElement = ElementBuilder.createNew()
            .type("http-sender")
            .originalId(DIFFERENT_ID_VALUE)
            .build();

        Element serviceCallElement = ElementBuilder.createNew()
            .type("service-call")
            .properties(Map.of(CamelOptions.SYSTEM_ID, SECOND_DIFFERENT_ID_VALUE))
            .build();

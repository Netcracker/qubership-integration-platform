...
public class KafkaCustomProducer extends DefaultAsyncProducer {
    ...
    public KafkaCustomProducer(KafkaCustomEndpoint endpoint) {
        super(endpoint);
    ...
    private void createProducer(Properties props) {
        ...
        try {
            ...
            Pair<Producer, Runnable> pair = endpoint.getKafkaClientFactory()
                .getProducerWithCloseCallback(props);
            kafkaProducer = pair.getLeft();
            onCloseCallback = pair.getRight();
    ...
    protected Iterator<KeyValueHolder<Object, ProducerRecord<Object, Object>>> createRecordIterable(
        ...
        return new KeyValueHolderCustomIterator(iterator, exchange, configuration, topic, propagatedHeaders);
    }

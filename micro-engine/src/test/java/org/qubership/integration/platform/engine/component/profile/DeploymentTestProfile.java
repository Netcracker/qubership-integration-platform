...
public class DeploymentTestProfile implements QuarkusTestProfile {
    ...
    private static final String EXCLUDED_TYPES = String.join(",",
            ...
            "org.qubership.integration.platform.engine.service.deployment.processing.actions.**",
    ...
    public List<TestResourceEntry> testResources() {
        return List.of(new TestResourceEntry(PostgresTwoDbTestResource.class), new TestResourceEntry(OpenSearchTestResource.class), new TestResourceEntry(ConsulTestResource.class));
    }
}

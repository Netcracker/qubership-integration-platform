...
class TestingContextTest {
    ...
    // testing-service/internal/model/testing_context_test.go. The three modules cannot see each other, so a
    // change on any side means they no longer agree on the wire format.

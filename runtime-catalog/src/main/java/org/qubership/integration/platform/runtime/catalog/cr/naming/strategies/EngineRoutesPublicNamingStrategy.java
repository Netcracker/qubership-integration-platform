...
@Component("engineRoutesPublicNamingStrategy")
public class EngineRoutesPublicNamingStrategy extends K8sResourceNamingStrategy<ResourceBuildContext<List<Snapshot>>> {
    ...
    @Autowired
    public EngineRoutesPublicNamingStrategy(
            ...
            @Value("${qip.cr.naming.engine-routes.public-suffix:-public-routes}")
            String suffix
    ) {
        super(nameVerifier);

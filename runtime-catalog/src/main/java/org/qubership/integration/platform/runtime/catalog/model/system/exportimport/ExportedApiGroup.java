...
@Getter
@Setter
public class ExportedApiGroup extends ExportedSystemObject {
    private List<ExportedSpecification> specifications;

    public ExportedApiGroup(String id, ObjectNode objectNode, List<ExportedSpecification> specifications) {
        super(id, objectNode);
    ...
    public void accept(ExportableObjectWriterVisitor visitor, ZipOutputStream zipOut, String entryPath) throws IOException {
        ...
        for (ExportedSpecification exportedSpecification : specifications) {
            exportedSpecification.accept(visitor, zipOut, entryPath);
        }
    }
}

...
import static org.qubership.integration.platform.runtime.catalog.validation.EntityValidator.ENTITY_NAME_REGEXP;
...
public class CommonVariablesController {
    ...
    public ResponseEntity<List<ImportVariableResult>> importVariables(
        ...
        List<ImportVariableResult> importedVariables = commonVariablesService.importVariables(file, variablesNames).getVariables();

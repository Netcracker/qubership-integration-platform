...
@Setter
@SuperBuilder
@Schema(name = "ChainsBySpecificationGroup", description = "Chains (without elements) grouped by API group")
public class ChainsByApiGroup {
    @Schema(description = "API group id")

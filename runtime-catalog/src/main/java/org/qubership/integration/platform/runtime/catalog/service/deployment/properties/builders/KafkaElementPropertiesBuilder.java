...
public class KafkaElementPropertiesBuilder implements ElementPropertiesBuilder {
    ...
    public Map<String, String> build(Element element) {
        Map<String, String> elementProperties = buildKafkaConnectionProperties(
                ...
                getPropertyAsString(element, BROKERS),
                ...
                getPropertyAsString(element, CONNECTION_SOURCE_TYPE_PROP)
        );
    ...
    public Map<String, String> buildKafkaConnectionProperties(
        ...
        properties.put(CONNECTION_SOURCE_TYPE_PROP, sourceType);
    ...
    public void enrichWithMaasProperties(Element element, Map<String, String> elementProperties) {
        ...
        if (isMaasKafkaTriggerOrSender(element)) {
            ...
            elementProperties.put(CamelOptions.MAAS_DEPLOYMENT_CLASSIFIER_PROP, ElementUtils.getPropertyAsString(element, CamelOptions.MAAS_TOPICS_CLASSIFIER_NAME_PROP));
    ...
    private boolean isMaasKafkaTriggerOrSender(Element element) {
        ...
        return (
                ...
                && MaasConnectionSourceUtils.isMaasConnectionSource(ElementUtils.getPropertyAsString(element, CONNECTION_SOURCE_TYPE_PROP));
    }

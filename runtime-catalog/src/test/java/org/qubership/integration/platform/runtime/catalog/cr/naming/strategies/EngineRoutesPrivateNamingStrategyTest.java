...
class EngineRoutesPrivateNamingStrategyTest {

    @Test
    void proposesNameWithDefaultSuffix() {
        NamingStrategy<ResourceBuildContext<List<Snapshot>>> integrationResourceNamingStrategy =
                context -> "my-domain-v1";
        EngineRoutesPrivateNamingStrategy strategy = new EngineRoutesPrivateNamingStrategy(
                new K8sNameVerifier(),
        ...
        assertEquals("my-domain-v1-private-routes", strategy.getName(context));
    }

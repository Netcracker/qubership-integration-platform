...
#
# Forbidden identifiers cannot live in this repository, so instead of matching
# names this check asserts the shape of the graph: every module path named by
# go.mod and go.sum has to sit under a prefix listed below. A dependency from
# anywhere else fails the check without anything having to name it.
#

...
type fakeTestCasesService struct {
	...
	// Nil unless a test records the call; unset, the bulk action reports success.
	bulkDelete func(context.Context, *[]uuid.UUID) error
...
func (s *fakeTestCasesService) BulkDelete(ctx context.Context, ids *[]uuid.UUID) error {
	if s.bulkDelete == nil {
		return nil
	}
...
type fakeTestsRunsService struct {
	...
	// Nil unless a test records the call; unset, the action reports success.
	delete     func(context.Context, uuid.UUID) error
	bulkDelete func(context.Context, *[]uuid.UUID) error
	bulkCancel func(context.Context, *[]uuid.UUID) error
...
func (s *fakeTestsRunsService) Delete(ctx context.Context, id uuid.UUID) error {
	if s.delete == nil {
		return nil
	}
	return s.delete(ctx, id)
...
func (s *fakeTestsRunsService) BulkDelete(ctx context.Context, ids *[]uuid.UUID) error {
	if s.bulkDelete == nil {
		return nil
	}
	return s.bulkDelete(ctx, ids)
...
func (s *fakeTestsRunsService) BulkCancel(ctx context.Context, ids *[]uuid.UUID) error {
	if s.bulkCancel == nil {
		return nil
	}
	return s.bulkCancel(ctx, ids)
}
...
func (s *fakeTestCaseRunsService) Cancel(ctx context.Context, id uuid.UUID) error {
	if s.cancel == nil {
		return nil
	}
	return s.cancel(ctx, id)
...
func (s *fakeTestCaseRunsService) BulkCancel(ctx context.Context, ids *[]uuid.UUID) error {
	if s.bulkCancel == nil {
		return nil
	}
	return s.bulkCancel(ctx, ids)
...
func (s *fakeEndpointMocksService) Delete(ctx context.Context, id uuid.UUID) error {
	if s.delete == nil {
		return nil
	}
	return s.delete(ctx, id)
...
func (s *fakeEndpointMocksService) BulkDelete(ctx context.Context, ids *[]uuid.UUID) error {
	if s.bulkDelete == nil {
		return nil
	}
	return s.bulkDelete(ctx, ids)

...
func (c *testsRunsController) FindById(ctx *fiber.Ctx) error {
	return findByID(ctx, c.responder, "tests run", "Tests run", c.testsRunsService.FindById)
}
...
func (c *testsRunsController) Delete(ctx *fiber.Ctx) error {
	return c.actOnID(ctx, "Failed to delete tests run", c.testsRunsService.Delete)
}
...
func (c *testsRunsController) BulkDelete(ctx *fiber.Ctx) error {
	return c.actOnIDs(ctx, "Failed to bulk delete tests runs", c.testsRunsService.BulkDelete)
}
...
func (c *testsRunsController) Cancel(ctx *fiber.Ctx) error {
	return c.actOnID(ctx, "Failed to cancel tests run", c.testsRunsService.Cancel)
}
...
func (c *testsRunsController) BulkCancel(ctx *fiber.Ctx) error {
	return c.actOnIDs(ctx, "Failed to bulk cancel tests runs", c.testsRunsService.BulkCancel)
}

...
func (s *endpointMocksService) importEndpointMock(ctx context.Context, entity *model.ExportedEntity) model.ImportResult {
	return importEntity(ctx, s.logger, entity, model.ExportedTypeEndpointMock, "endpoint mock",
		func(ctx context.Context, endpointMock *dao.EndpointMock) (string, error) {
...
func (s *endpointMocksService) Export(ctx context.Context, ids *[]uuid.UUID) (*[]byte, error) {
	...
	return writeExportArchive(endpointMocks, func(endpointMock dao.EndpointMock) (model.ExportedEntity, any) {

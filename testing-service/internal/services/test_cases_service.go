...
func (s *testCasesService) Import(ctx context.Context, fileHeaders []*multipart.FileHeader) (*[]model.ImportResult, error) {
	return importArchives(fileHeaders, func(entity *model.ExportedEntity) model.ImportResult {
...
func (s *testCasesService) importTestCase(ctx context.Context, entity *model.ExportedEntity) model.ImportResult {
	return importEntity(ctx, s.logger, entity, model.ExportedTypeTestCase, "test case",
		func(ctx context.Context, testCase *dao.TestCase) (string, error) {
			return dao.RunInTx(ctx, s.runner, func(ctx context.Context) (string, error) {
...
func (s *testCasesService) Export(ctx context.Context, ids *[]uuid.UUID) (*[]byte, error) {
	...
	// The exported payload is the test case itself, not the view it is read
	// through.
	return writeExportArchive(testCases, func(testCase dao.TestCaseView) (model.ExportedEntity, any) {

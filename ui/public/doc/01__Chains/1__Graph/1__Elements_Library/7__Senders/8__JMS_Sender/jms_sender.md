...
| Type                   | M                                       | List                                    | Type of the destination: <li>queue</li> <li>topic</li><br>**Default value**: queue                                                                                                                  | queue                                        |
...
| Message type            | M                                       | List                                    | Type of the message: <li>Bytes</li><li>Map</li><li>Object</li><li>Stream</li><li>Text</li><br>**Default value:** Bytes                                                                              | Bytes                                        |

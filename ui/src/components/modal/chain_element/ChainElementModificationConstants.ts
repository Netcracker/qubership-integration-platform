...
export const pathToTabMap: Record<string, string> = {
  ...
  "properties.authorizationConfiguration.type": "Authorization",
  "properties.authorizationConfiguration.data": "Authorization",
  "properties.authorizationConfiguration.data.username": "Authorization",
  "properties.authorizationConfiguration.data.password": "Authorization",
  "properties.authorizationConfiguration.data.token": "Authorization",

    ...
    try {
      ...
      notificationService.info(
        ...
        chainId ? (
          ...
          // Notification content renders above the router, where an href cannot
          // be resolved, so this is a button rather than a link.
          <Button
            type="link"
            size="small"
            style={{ padding: 0, height: "auto" }}
            onClick={() => void navigate(`${TESTS_RUNS_PATH}/${runId}`)}
          >
            {runId}
          </Button>
        ),

...
export function getThemeTokens(isDark: boolean): Partial<AliasToken> {
  ...
  const panelBg = getCSSVariable(
    "--vscode-panel-background",
    isDark ? "#1f1f1f" : "#fafafa",
  );
  const foreground = getCSSVariable(
    "--vscode-foreground",
  ...
  const linkColor = getCSSVariable(
    "--vscode-textLink-foreground",
    isDark ? "#69b1ff" : "#1677ff",
  );
  const errorColor = getCSSVariable(
    "--vscode-errorForeground",
    isDark ? "#f48771" : "#d73a49",
  );
  const warningColor = getCSSVariable(
    "--vscode-warningForeground",
    isDark ? "#ffcc02" : "#e36209",
  );
  const inputBg = getCSSVariable(
  ...
  return {
    ...
    colorTextSecondary: getCSSVariable(
    ...
    colorSuccess: getCSSVariable(
      "--vscode-terminal-ansiGreen",
      isDark ? "#4ec9b0" : "#28a745",
    ),
    colorInfo: linkColor,

    colorBgTextHover: getCSSVariable(
...
export function deepMergeThemeConfig(
  ...
  if (overrides.components) {
    ...
    for (const [componentName, overrideValue] of Object.entries(
      overrideComponents,
    )) {
...
export function getAntdThemeConfig(
  ...
  const modalBg = getCSSVariable(
    "--vscode-modal-background",
    tokens.colorBgElevated ??
      tokens.colorBgBase ??
      (isDark ? "#1f1f1f" : "#fafafa"),
  );
  const modalForeground = getCSSVariable(
    "--vscode-modal-foreground",
    tokens.colorText ??
      (isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.88)"),
  );
  ...
  const baseConfig: ThemeConfig = {
    ...
    components: {
      Layout: {
        headerBg: getCSSVariable(
          "--vscode-editor-background",
          isDark ? "#141414" : "#ffffff",
        ),
        bodyBg: getCSSVariable(
          "--vscode-editor-background",
          isDark ? "#141414" : "#ffffff",
        ),
        siderBg: getCSSVariable(
      ...
      Menu: {
        itemBg: "transparent",
        itemSelectedBg: getCSSVariable(
          "--vscode-list-activeSelectionBackground",
          "#0078d4",
        ),
        itemSelectedColor: getCSSVariable(
          "--vscode-list-activeSelectionForeground",
          "#ffffff",
        ),
        itemHoverBg: getCSSVariable(
          "--vscode-list-hoverBackground",
          isDark ? "#262626" : "#f5f5f5",
        ),
      },
      Table: {
        ...
        colorTextHeading: getCSSVariable(
          "--vscode-foreground",
          isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.88)",
        ),
      },
      ...
      List: {
        ...
        colorTextDescription: getCSSVariable(
          "--vscode-descriptionForeground",
          isDark ? "#9ca3af" : "#9ca3af",
        ),
      },
      Form: {
        labelColor: getCSSVariable(
          "--vscode-foreground",
          isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.88)",
        ),
      },
      Tooltip: {
        colorBgSpotlight: getCSSVariable(
          "--vscode-panel-background",
          isDark ? "#1f1f1f" : "#fafafa",
        ),
        colorTextLightSolid: getCSSVariable(
          "--vscode-foreground",
          isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.88)",
        ),
        colorBorder: getCSSVariable(
      ...
      Segmented: {
        ...
        itemHoverColor: getCSSVariable(
          "--vscode-foreground",
          isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.88)",
        ),
        trackBg: getCSSVariable(
          "--vscode-editor-background",
          isDark ? "#141414" : "#ffffff",
        ),
        trackPadding: 2,
      ...
      Tabs: {
        ...
        itemActiveColor: getCSSVariable(
          "--vscode-textLink-foreground",
          isDark ? "#69b1ff" : "#1677ff",
        ),

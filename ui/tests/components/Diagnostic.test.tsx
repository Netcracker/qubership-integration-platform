...
jest.mock(
  "../../src/components/dev_tools/useDiagnosticValidationFilters",
  () => ({
...
jest.mock("../../src/components/dev_tools/DiagnosticValidationModal", () => ({
...
} from "../../src/components/dev_tools/Diagnostic";
